...
> 本文是 [YYC³ 团队统一开发标准](./YYC3-AI-Family-Token-Console-团队规范/标规文档/YYC3-团队规范-开发标准.md) 在本仓库的**执行细则**——不重复标准原文，只定义「标准 → 本仓库实况」的对应关系。
...
| 文档 | 用途 |
| ---- | ---- |
| [YYC3-团队核心-五维驱动](./YYC3-AI-Family-Token-Console-团队规范/标规文档/YYC3-团队核心-五维驱动.md) | 五高五标五化五维官方标准全文 |
| [YYC3-团队规范-开发标准](./YYC3-AI-Family-Token-Console-团队规范/标规文档/YYC3-团队规范-开发标准.md) | 文档/代码/命名/质量全量标准 |
| [YYC3-团队规范-文档闭环](./YYC3-AI-Family-Token-Console-团队规范/标规文档/YYC3-团队规范-文档闭环.md) | 文档生命周期闭环机制 |
| [YYC3-团队通用-开发文档](./YYC3-AI-Family-Token-Console-团队规范/标规文档/YYC3-团队通用-开发文档.md) | AI 协同开发流程（00-03 文档体系） |
| [YYC3-多端适配-规范文档](./YYC3-AI-Family-Token-Console-团队规范/标规文档/YYC3-多端适配-规范文档.md) | PWA 五端适配规范 |
| [验收系统/](./YYC3-AI-Family-Token-Console-团队规范/验收系统/) | 16 篇验收标准（a11y/视觉/契约/性能等） |
| [模版闭环/](./YYC3-AI-Family-Token-Console-团队规范/模版闭环/) | 团队协作风暴板母版（本文档套件的蓝本） |
